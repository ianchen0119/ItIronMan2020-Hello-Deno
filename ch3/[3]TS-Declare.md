...
>
> > 在介紹完 Deno 由來以後，我們正式進入到了 TypeScript 的學習路程上，開始之前還是想先讓讀者知道為何我們需要學會TypeScript。
>
> Deno 由於使用了 V8 引擎以及內建 TypeScript 編譯器，所以不管是 Js 或是 Ts 都能直接在 Deno 運行。
>
...
>
> ![3-1](https://github.com/ianchen0119/ItIronMan2020-Hello-Deno/raw/master/ch3/3-1.png)
>
...
>
> ![3-2](https://github.com/ianchen0119/ItIronMan2020-Hello-Deno/raw/master/ch3/3-2.png)
>
...
> ## 總結
>
> 哇！經過一天，各位讀者一共學到了 `提升`、`暫時性死區`、`範圍鏈`、`型別概念`，是不是覺得自己變的更加專業了呢？
>
> > 請不要告訴我沒有 :)
>
> 題外話： 因為筆者沒睡好落枕加上本篇篇幅較長，如果文章內容出現錯誤也十分歡迎~~打臉~~協助勘誤。
>
> ## 延伸閱讀
>
